              ...
              <div key={user.id}>
                <List sx={{ display: 'flex' }}>
                  <ListItem sx={{ display: 'flex' }}>
                    <Avatar alt={user.name} src={user.photo} sx={{ mr: '10px' }} />
                  ...
                  <ListItem>
                    <ListItemText primary='Registration Timestamp' secondary={new Date(user.registration_timestamp * 1000).toLocaleDateString()} />
                  </ListItem>
                </List>
              </div>
            )
